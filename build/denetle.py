...
NEDEN VAR: bu sitede denetim betiği YOKTU ve mekân sayfalarının başlık kalıbı
yapısal olarak bozuk kaldı — sabit kısmı tek başına 59 karakterdi, yani mekân
adı ne olursa olsun 62 sınırı aşılıyordu (en uzunu 116) ve açıklamalar 214-253
karakterdi. Aylarca fark edilmedi. Bir daha sessizce bozulmasın diye derlemeden
sonra bu betik çalıştırılır.
